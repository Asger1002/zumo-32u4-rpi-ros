...
const double TICKS_PER_REVOLUTION = 910; // For reference purposes.
const double WHEEL_RADIUS = 0.0388; // Wheel radius in meters
const double WHEEL_BASE = 0.0959; // Center of left tire to center of right tire
const double TICKS_PER_METER = 3732; // technically 3731.52695215, based on 909.7 CPR and wheel dia 0.0388m
